...
internal static class ResponseBudget
{
    ...
    /// of its own either, so a long list is cut here or not at all — and half of
    /// <see cref="ProjectListCap"/> because a filter row carries a line of JQL and so weighs
    /// several times what a project row does. Fifty favourites is also well past the point where a
    /// person still knows what they have.
    /// </summary>
